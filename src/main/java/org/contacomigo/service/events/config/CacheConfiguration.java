...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("events");
        ...
        config.getMapConfigs().put("org.contacomigo.service.events.domain.*", initializeDomainMapConfig(jHipsterProperties));
